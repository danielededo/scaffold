...
[The decision, stated in one or two affirmative sentences: "We will use X to do
Y." Follow with the key reasons it won.]
...
[Include the option you chose. Two or three options are usually enough; "do
nothing" is often a legitimate option worth listing.]
...
- [links to issues, PRs, benchmarks, docs that informed the decision]
